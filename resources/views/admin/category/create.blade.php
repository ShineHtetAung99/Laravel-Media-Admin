                        ...
                        <div class="active tab-pane" id="activity">
                            <form class="form-horizontal" method="post" action="{{ route('admin#createCategory') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="categoryTitle" class="form-control" value=""
                                            placeholder="Title">
                                        @error('categoryTitle')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" name="categoryDescription" cols="30" rows="5" placeholder="Description"></textarea>
